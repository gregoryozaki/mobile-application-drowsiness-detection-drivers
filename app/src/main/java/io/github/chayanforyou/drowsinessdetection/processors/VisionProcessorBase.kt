...
import io.github.chayanforyou.drowsinessdetection.executors.ScopedExecutor
import io.github.chayanforyou.drowsinessdetection.overlay.GraphicOverlay
import io.github.chayanforyou.drowsinessdetection.CameraImageGraphic
import io.github.chayanforyou.drowsinessdetection.InferenceInfoGraphic
import io.github.chayanforyou.drowsinessdetection.utils.BitmapUtils
...
abstract class VisionProcessorBase<T>(context: Context) : VisionImageProcessor {
    ...
    protected var framesPerSecond = 0
    protected var eyesClosedCount = 0
    protected var alarmCount = 0
    ...
    private fun processImage(
        ...
        requestDetectInImage(
            ...
            graphicOverlay, bitmap,/* shouldShowFps= */  frameStartMs
        )
            .addOnSuccessListener(executor) { processLatestImage(graphicOverlay) }
    }
